    ...
    def write_text(self):
        ...
        try:
            for movie in self.movie_list:
                ...
                file_top.write('导演：' + movie[4] + '\r\n')
                file_top.write('年份：' + movie[5] + '\r\n')
                file_top.write('国家：' + movie[6] + '\r\n')
                file_top.write('类别：' + movie[7] + '\r\n')
                file_top.write('评分：' + movie[8] + '\r\n')
                file_top.write('人数：' + movie[9] + '\r\n')
                file_top.write('影评：' + movie[10] + '\r\n')
            print("抓取结果写入文件成功。")
